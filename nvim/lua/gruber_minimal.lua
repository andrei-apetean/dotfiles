...
local groups = {
  ...
  SpellBad = { fg = colors.red, underline = false },
  SpellCap = { fg = colors.yellow, underline = false },
  ...
  -- html
  -- htmlLink = { fg = colors.niagara, underline = false},
  ...
  -- markdownUrl = { fg = colors.niagara, underline = false},
...
vim.g.colors_name = "gruber-minimal"
